"""Define the Acquire persistence model and transactional session boundary.

The module owns runtime Postgres engine configuration, SQLAlchemy metadata,
application models, and the session lifecycle shared by request-serving and
offline workflows.
"""
